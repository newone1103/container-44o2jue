...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-44o2jue.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-44o2jue.containers.anotherwebservice.com/
...
```
git clone git@github.com:newone1103/container-44o2jue.git
cd container-44o2jue
```
...
```
docker attach container-44o2jue
```
